...
#define POZYX_DELAY_LOCAL_WRITE     10
#define POZYX_DELAY_LOCAL_FUNCTION  50
#define POZYX_DELAY_REMOTE_WRITE    50
#define POZYX_DELAY_REMOTE_FUNCTION 100
#define POZYX_DELAY_INTERRUPT       200
